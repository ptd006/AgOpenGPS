...
namespace AgOpenGPS
{
    public partial class FormCommSet : Form
    {
        ...
        private void FormCommSet_Load(object sender, EventArgs e)
        {
            ...
            else if (Properties.Settings.Default.setGPS_fixFromWhichSentence == "UBX") rbtnUBX.Checked = true;
